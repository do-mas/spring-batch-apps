...
import com.batch.xlsx.step.mapper.ExcelRowMapper;
import com.batch.utils.ExcelFileParseException;
...
public class ExcelItemReader<T> extends AbstractItemCountingItemStreamItemReader<T> {
    ...
    public ExcelItemReader(Resource resource, int linesToSkip, ExcelRowMapper<T> rowMapper) {
        super();
